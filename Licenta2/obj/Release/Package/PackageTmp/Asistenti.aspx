<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Asistenti.aspx.cs" Inherits="Licenta2.Asistenti" %>
...
<ul class="topnav">
  ...
  <li><a class="active"  href="Asistenti.aspx"><h2>Asistenți & Sfaturi</h2></a></li>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
   ...
   <a href="#" onclick="openpopup1()" class="btn btn-primary"style="background-color:#625772; font-family: 'Roboto Mono', monospace;
 ...
 <div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
   ...
   <a href="inregistrare.aspx" class="btn btn-primary" style="background-color:#625772; font-family: 'Roboto Mono', monospace;
    font-size: 1.25rem;">Să începem cu primul pas- Crearea contului</a>  </div>
</div>
 ...
 <div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    font-size: 1.25rem;">Haide la pagina de contact!</a>
