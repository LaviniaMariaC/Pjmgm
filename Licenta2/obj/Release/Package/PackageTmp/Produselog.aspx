<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Produselog.aspx.cs" Inherits="Licenta2.Produselog" %>
...
<ul class="topnav">
  ...
  <li><a  class="active" href="Produselog.aspx" style="font-family: 'Roboto Mono', monospace;"><h2>Catalog</h2></a></li>
  <li><a  href="Asistentilog.aspx"><h2>Asistenți & Sfaturi</h2></a></li>
      <li><a  href=Contactlog.aspx><h2>Contact</h2></a></li>
  <li > <a href="Client.aspx" ><h2> Programează-te</h2> </a> </li> 
   
   <li > <a  href="RezervariC.aspx" ><h2> Vizualizare rezervări</h2> </a> </li> 
	 <li class="right"><a href="index.aspx"><h2>Ieși din cont</h2></a></li>
</ul> 
    ...
    width: 100%;
                   ...
                   <img   src="images/machiaj/9.jpg" alt="" style="width:auto;max-width:auto">
   	 	  	  	  	   ...
   	 	  	  	  	   <div class="text">
  	 	  	  	  	   	  ...
  	 	  	  	  	   	  <p></p> 
  	 	  	  	              <br /> 
  	 	  	  	  	   	  <a href="exemplelog.aspx#makeup" role="button" class="btn"style="font-size:2rem">Vezi mai mult..</a>
  	 	  	  	  	   </div>
  	 	  	  	  </div>
  	 	  	  </div>
  ...
  .modal-content {
    width: 100%;
  	 	  	  	  	   ...
  	 	  	  	  	   <div class="text">
  	 	  	  	  	     ...
  	 	  	  	  	     <a href="exemplelog.aspx#mani" role="button" class="btn"style="font-size:2rem">Vezi mai mult..</a>
  	 	  	  	  	   </div>
  	 	  	  	  </div>
  	 	  	  </div>
  	 	  	  ...
  	 	  	  <div class="box wow bounceInUp" data-wow-delay="0.4s">
  	 	  	  	  <div class="inner">
  	 	  	  	   	  ...
  	 	  	  	   	  <a href="exemplelog.aspx#pedi" role="button" class="btn"style="font-size:2rem">Vezi mai mult..</a>
  	 	  	  	  	   </div>
  	 	  	  	  </div>
  	 	  	  </div>
  	 	    ...
  	 	    <div class="box wow bounceInUp">
  	 	  	  	  <div class="inner">
  	 	  	  	  	   ...
  	 	  	  	  	   <div class="text">
  	 	  	  	              ...
  	 	  	  	              <br /> 
  	 	  	  	  	   	  <a href="exemplelog.aspx#cosm" role="button" class="btn"style="font-size:2rem">Vezi mai mult..</a>
  	 	  	  	  	   </div>
  	 	  	  	  </div>
  	 	  	  </div>
  	 	  	  <div class="box wow bounceInUp" data-wow-delay="0.2s">
  	 	  	  	  <div class="inner">
  	 	  	  	   	  ...
  	 	  	  	   	  <a href="exemplelog.aspx#coaf" role="button" class="btn"style="font-size:2rem">Vezi mai mult..</a>
  	 	  	  	  	   </div>
  	 	  	  	  </div>
  	 	  	  </div>
  	 	  	  <div class="box wow bounceInUp" data-wow-delay="0.4s">
