<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contactlog.aspx.cs" Inherits="Licenta2.Contactlog" %>
...
.contact .content .text .copy{
  ...
  <li><a  href="Acasalog.aspx" style="  font-family: 'Roboto Mono', monospace;
    font-size: 1.25rem;
    font-weight: 800;
    line-height: 2;"><h3>Acasă</h3></a></li>
  <li><a   href="Produselog.aspx" style="font-family: 'Roboto Mono', monospace;"><h3>Catalog</h3></a></li>
  <li><a  href="Asistentilog.aspx"><h3>Asistenți & Sfaturi</h3></a></li>
      <li ><a class="active" href=Contactlog.aspx><h3>Contact</h3></a></li>
    <li > <a href="Client.aspx" ><h3> Programează-te</h3> </a> </li> 
   
   <li > <a  href="RezervariC.aspx" ><h3> Vizualizare rezervări</h3> </a> </li> 
	 <li class="right"><a href="index.aspx"><h3>Ieși din cont</h3></a></li>
    </ul>
   ...
   <asp:Label ID="Label1" runat="server" CssClass="col-md-2 control-label col-md-offset-3" Text="Nume "></asp:Label>
                    <div class="col-md-3">
                         <asp:TextBox ID="txtNume" CssClass="form-control" placeholder=" " runat="server"></asp:TextBox>
                        </div>
</div>
                    <br />
          					<div class="form-group">
                    ...
                    <div class="col-md-3">
                        <asp:TextBox ID="txtemaill" CssClass="form-control" placeholder=""  runat="server"></asp:TextBox>
                    </div>
                </div>
                    <br />

                    <div class="form-group">
                    <asp:Label ID="txlvl1" runat="server" CssClass="col-md-2 control-label col-md-offset-3" Text="Subiect"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtsub" CssClass="form-control" placeholder=""  runat="server"></asp:TextBox>
                    </div>
                </div>
                    <br />

                    <div class="form-group">
                    <asp:Label ID="Label4" runat="server" CssClass="col-md-2 control-label col-md-offset-3" Text="Mesaj"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtmes" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                    </div>
                </div>
                    <br />
                    <!--
                   ...
                   <asp:Label ID="Label9" runat="server" CssClass="col-md-2 control-label col-md-offset-3" Text="Tip utilizator"></asp:Label>
                    ...
                    <br />                      <div class="col-md-11">

                    <asp:CheckBox runat="server" text="Sunt de acord ca datelele să îmi fie stocate și utilizate de către Beauty Concept." ID="deacord" CausesValidation="True"></asp:CheckBox>
  </div>

               <center><div class="form-group">
                    <div class="col-md-2 "></div>
                    <div class="col-md-11">
<asp:Button ID="btnAdd" runat="server" Class="btn btn-success" Text="Trimite Mesaj" Height="35px" OnClick="btnAdd_Click"  />
                        <asp:Label ID="lblcnpAdd" runat="server"></asp:Label>                      </div>
                </div>
                  </center> <br/> <br/> <br/> 
                    <hr style="width:auto;text-align:left;margin-left:0;height:6px">
                    <center>
                              <div class="col-md-11 d-flex align-items-stretch">
								<div class="info-wrap w-100 p-lg-5 p-4 img">
 									<p class="mb-4">Orice sugestie ne este de ajutor!</p>
				        	<div class="dbox w-100 d-flex align-items-start">
				        		<div class="icon d-flex align-items-center justify-content-center">
				        			<span class="fa fa-map-marker"></span>
				        		</div>
				        		<div class="text pl-3">
					            <p><span>Adresa: </span><a href="https://www.google.com/maps/place/Strada+Narcisei,+Timi%C8%99oara/@45.7226572,21.242383,18z/data=!4m5!3m4!1s0x47455dc58f4bd877:0x37fa39c3cedb5438!8m2!3d45.7224119!4d21.2426995">Strada Narciselor, nr. 2, casa nr.10 Timișoara </a> </p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-center">
				        		...
				        		<div class="text pl-3">
					            <p><span>Număr de telefon:</span> <a href="tel:+40754642483">+40754642483</a></p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-center">
				        		<div class="icon d-flex align-items-center justify-content-center">
				        		...
				        		<div class="text pl-3">
					            <p><span>Email:</span> <a href="mailto:support.bc@gmail.com">support.bc@gmail.com</a></p>
					          </div>
				          </div>
