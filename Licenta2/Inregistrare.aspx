...
<li><a href="index.aspx"><img class="img-circle" alt="Logo" src="images/logo.jpg"   height="50" /> </a></li>                         
  ...
  <li><a href="Asistenti.aspx"><h3>Asistenți & Sfaturi</h3></a></li>
   ...
   <asp:Label ID="Label1" runat="server" CssClass="col-md-2 control-label col-md-offset-3" Text="Nume utilizator"></asp:Label>
                    ...
                    <br />
                    <asp:CheckBox runat="server" placeholder="Sunt de acord ca datele să îmi fie utilizate de BC" ID="bifa" Text="Sunt de acord ca datele să îmi fie utilizate de BC"></asp:CheckBox>
                    <asp:CheckBox runat="server" ID="bifa1" Text="Sunt de acord cu termenii și condițiile!"></asp:CheckBox>
