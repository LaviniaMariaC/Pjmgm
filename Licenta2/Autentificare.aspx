<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Autentificare.aspx.cs" Inherits="Licenta2.Autentificare" %>
...
<li><a  href="Acasa.aspx"  ><h3>Acasă</h3></a></li>
  ...
  <li class="right"><a href="Inregistrare.aspx"><h3>Înregistrare</h3></a></li>
    <li class="right"><a class="active" href="Autentificare.aspx"><h3>Autentificare</h3></a></li>                      </ul>  
              </div>
	<div class="limiter">
  ...
  <asp:Label ID="Label1"  runat="server" CssClass="col-md-2 control-label col-md-offset-3" Text="Utilizator"></asp:Label>
     <div class="col-md-3">
         <asp:TextBox ID="Utilizator" CssClass="form-control "  runat="server"></asp:TextBox>
         </div>
</div>
                    <br />
                    <br />
					...
					<div class="form-group">
                    <asp:Label ID="Label2"  runat="server" CssClass="col-md-2 control-label col-md-offset-3" Text="Parolă"></asp:Label>
                    <div class="col-md-3">
                    <asp:TextBox ID="Parola"  CssClass="form-control " runat="server" TextMode="Password"></asp:TextBox>
                    </div>
                </div>
                    <br />
                    <br />
               ...
               <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:Button ID="Button2" runat="server" Text="Autentificare" CssClass="btn btn-success "  OnClick="Button2_Click2"/>
                    </div>
                </div>
                    <div class="form-group">
